...
interface leaveAReviewProp {
    submitReview: any;
}



export const LeaveAReview = ({ submitReview }: leaveAReviewProp) => {
        ...
        <div className='dropdown' style={{ cursor: 'pointer' }}>
            ...
            {displayInput &&
                <form method='POST' action='#' >
                    ...
                    <div>
                        <button type='button' className='btn btn-primary mt-3' onClick={() => { submitReview(starInput, reviewDescription) }}>
                            Submit Review
                        </button>
                    </div>
                </form>
